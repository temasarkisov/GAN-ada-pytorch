# python dataset_tool.py --source=../stylegan2-ada/data/thenounproject_rainbow_inverted --dest=datasets/dataset_thenounproject_rainbow_inverted.zip
# python dataset_tool.py --source=../stylegan2-ada/data/nude-painting-nu --dest=datasets/dataset_nude-painting-nu.zip
